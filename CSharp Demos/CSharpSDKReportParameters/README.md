# FastReport Cloud Report Parameters C# SDK Demo

## Overview
This application demonstrates how Report Parameters work in FastReport Cloud using the C# SDK.

## Getting Started

1. Install the NuGet package FastReport.Cloud.SDK (C# SDK) - `dotnet add package FastReport.Cloud.SDK`
2. To use this application, set your API key into `Startup.cs` for authentication and authorization.
