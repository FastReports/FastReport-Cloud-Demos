# FastReport Cloud API Demo

## Overview
This demo application demonstrates working with the FastReport Cloud API:
- Uploading a report template (.frx)
- Exporting the template to PDF format
- Downloading the exported file
- Deleting files

To use this application, enter your API key for authentication and authorization.
